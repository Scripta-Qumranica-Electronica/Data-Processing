/**
 * This script reads all the names from iaa_edition_catalog (the IAA's catalog)
...
const getImageCols = async pool => {
    try {
        ...
        const rows = await conn.query(`SELECT DISTINCT scroll_id, iaa_edition_catalog_id AS ed_id, edition_location_1 AS loc1, edition_location_2 AS loc2
